...
List.prototype.__proto__ = Key.prototype;
...
/**
 * Remove `count` of `val` and invoke `fn(err, removed)`.
 *
 * @param {Function} fn
 * @return {List} for chaining
 * @api public
...
List.prototype.remove = function(count, val, fn){
  return this.client.lrem(this.key, count, val, fn || function(){});
};
